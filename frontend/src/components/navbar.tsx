...
export default function Navbar() {
	...
	return (
		<div className="flex items-center justify-between py-4 mx-20 ">
			<Link
				href="/"
				className="font-serif font-normal text-2xl text-black "
			>
				PRAEDIUM
			</Link>
            ...
            <button onClick={logout} className="text-black font-normal">
              Sair
            </button>
					</div>
				) : (
					<Link href={'/login'} className="text-orange font-normal">
						Entrar
					</Link>
				)}
			</div>
